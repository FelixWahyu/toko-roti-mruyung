...
@section('content')
    <div class="min-h-screen w-full grid grid-cols-1 lg:grid-cols-12 bg-white">
        <div class="hidden lg:flex lg:col-span-6 xl:col-span-6 relative bg-stone-900 flex-col justify-between p-10 xl:p-12 overflow-hidden">
            <img src="{{ asset('images/galery/foto-kue-mruyung.webp') }}" alt="Koleksi Kue & Roti Mruyung"
            ...
            <div class="relative z-10 text-white space-y-4">
                <h2 class="text-2xl xl:text-3xl font-bold font-serif leading-tight text-white">
                    Nikmati Kemudahan Pemesanan & Promo Spesial
                </h2>
                <p class="text-sm text-stone-300 font-light leading-relaxed max-w-md">
                    Daftarkan akun untuk memesan roti favorit, reservasi meja cafe, kamar guest house, dan nikmati diskon eksklusif.
                </p>
        ...
        <div class="lg:col-span-6 xl:col-span-6 flex flex-col justify-between p-6 sm:p-10 lg:p-12 xl:p-16 bg-[#FAF8F5] min-h-screen">
            ...
            <div class="w-full max-w-lg mx-auto my-auto py-6">
                <div class="mb-6">
                    <h1 class="text-3xl font-bold text-gray-900 font-serif">Registrasi Akun</h1>
                    <p class="mt-2 text-sm text-stone-500">Lengkapi data Anda di bawah ini untuk membuat akun baru</p>
                </div>

                <form method="POST" action="{{ route('register') }}" class="space-y-4">
                    @csrf
                    <div>
                        <label for="name" class="block text-xs font-semibold uppercase tracking-wider text-stone-600 mb-1.5">Nama Lengkap</label>
                        <div class="relative">
                            ...
                            <input id="name" name="name" type="text" required value="{{ old('name') }}"
                                ...
                                class="w-full pl-10 pr-3.5 py-2.5 bg-white border border-stone-300 rounded-md text-sm text-gray-900 placeholder-stone-400 focus:outline-none focus:ring-2 focus:ring-amber-500/20 focus:border-amber-600 transition-all duration-200 shadow-xs @error('name') border-red-500 bg-red-50/30 @enderror">
                        </div>
                        @error('name')
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                            ...
                            <div class="relative">
                                <div class="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none text-stone-400 font-semibold text-sm">
                                    @
                                </div>
                                <input id="username" name="username" type="text" required value="{{ old('username') }}"
                                    placeholder="username"
                                    class="w-full pl-9 pr-3.5 py-2.5 bg-white border border-stone-300 rounded-md text-sm text-gray-900 placeholder-stone-400 focus:outline-none focus:ring-2 focus:ring-amber-500/20 focus:border-amber-600 transition-all duration-200 shadow-xs @error('username') border-red-500 bg-red-50/30 @enderror">
                            </div>
                            @error('username')
                                <p class="mt-1.5 text-xs text-red-600 font-medium flex items-center gap-1">
                                    <svg class="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 20 20">
                        ...
                        <div>
                            <label for="email" class="block text-xs font-semibold uppercase tracking-wider text-stone-600 mb-1.5">Alamat Email</label>
                            <div class="relative">
                                <div class="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none text-stone-400">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8"
                                ...
                                <input id="email" name="email" type="email" required value="{{ old('email') }}"
                                    ...
                                    class="w-full pl-10 pr-3.5 py-2.5 bg-white border border-stone-300 rounded-md text-sm text-gray-900 placeholder-stone-400 focus:outline-none focus:ring-2 focus:ring-amber-500/20 focus:border-amber-600 transition-all duration-200 shadow-xs @error('email') border-red-500 bg-red-50/30 @enderror">
                            </div>
                            @error('email')
                                <p class="mt-1.5 text-xs text-red-600 font-medium flex items-center gap-1">
                                    <svg class="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4" x-data="{ showPassword: false }">
                        <div>
                            <label for="password" class="block text-xs font-semibold uppercase tracking-wider text-stone-600 mb-1.5">Password</label>
                            <div class="relative">
                                <div class="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none text-stone-400">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8"
                        ...
                        <div>
                            <label for="password_confirmation" class="block text-xs font-semibold uppercase tracking-wider text-stone-600 mb-1.5">Konfirmasi Password</label>
                            <div class="relative">
                                <div class="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none text-stone-400">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8"
                                ...
                                <input id="password_confirmation" name="password_confirmation" :type="showPassword ? 'text' : 'password'" required
                                    ...
                                    class="w-full pl-10 pr-3.5 py-2.5 bg-white border border-stone-300 rounded-md text-sm text-gray-900 placeholder-stone-400 focus:outline-none focus:ring-2 focus:ring-amber-500/20 focus:border-amber-600 transition-all duration-200 shadow-xs">
                            </div>
                        </div>
                    </div>
                ...
                <div class="mt-8 pt-6 border-t border-stone-200 text-center">
                    <p class="text-sm text-stone-500">
                        Sudah punya akun?
                        <a href="{{ route('login') }}" class="font-semibold text-brown-500 hover:text-brown-600 ml-1 transition-colors">
                            Masuk di sini
                        </a>
                    </p>
                </div>
