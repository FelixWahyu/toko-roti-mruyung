...
@section('content')
    <div class="relative bg-white overflow-hidden">
        <div class="max-w-7xl mx-auto">
            <div class="lg:grid lg:grid-cols-2 lg:mt-8 lg:gap-8">
                <div
                    class="relative z-10 pb-8 bg-white sm:pb-16 md:pb-20 lg:w-full lg:pb-28 xl:pb-32 flex flex-col justify-center px-4 sm:px-6 lg:px-8 pt-10 lg:pt-0">
                    <main class="mx-auto max-w-7xl lg:mx-0">
                            ...
                            <div class="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start gap-3">
                                <div class="rounded-md shadow">
                                    <a href="{{ route('products.index') }}"
                                        class="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-white bg-brown-500 hover:bg-brown-600 md:py-4 md:text-lg md:px-10 transition duration-300">
                                        Lihat Produk
                                    </a>
                                </div>
                                <div class="mt-3 sm:mt-0">
                                    <a href="{{ route('about') }}"
                                        class="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-brown-700 bg-brown-100 hover:bg-brown-200 md:py-4 md:text-lg md:px-10 transition duration-300">
                                        Tentang Kami
                                    </a>
                                </div>
                            </div>
                ...
                <div class="relative lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2 h-64 sm:h-72 md:h-96 lg:h-full">
                    <video id="heroVideo"
                        class="absolute inset-0 w-full h-full object-cover transition-opacity duration-1000" muted loop
                        playsinline poster="{{ asset('images/galery/toko-roti.webp') }}">
                        <source src="{{ asset('videos/review-video-2025.mp4') }}" type="video/mp4">
                        Browser Anda tidak mendukung tag video.
                    </video>
                    <div
                        class="hidden lg:block absolute inset-y-0 left-0 w-16 bg-gradient-to-r from-white to-transparent pointer-events-none">
                    </div>
                </div>
            </div>
        </div>
