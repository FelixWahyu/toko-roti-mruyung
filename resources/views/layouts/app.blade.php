...
<body class="font-serif antialiased bg-gray-50 text-gray-800 pt-16">
    ...
    <a href="https://wa.me/{{ preg_replace('/^0/', '62', preg_replace('/[^0-9]/', '', $globalSettings['store_contact']->value ?? '')) }}"
        target="_blank"
        class="fixed bottom-6 right-6 z-50 flex items-center justify-center w-16 h-16 bg-[#25D366] text-white rounded-full shadow-2xl hover:bg-[#20ba5a] hover:scale-110 transition-all duration-300 focus:outline-none focus:ring-4 focus:ring-green-300"
