                        ...
                        <div class="lg:col-span-5 flex flex-col items-center lg:items-end">
                            <div class="w-full max-w-md bg-white/10 backdrop-blur-xl border border-white/15 p-6 sm:p-8 rounded-2xl shadow-xl space-y-4">
                                ...
                                <div class="space-y-3 pt-2">
                                    <a href="https://wa.me/{{ $globalSettings['store_contact']->value ?? '' }}?text=Halo%20Roti%20Mruyung,%20saya%20mau%20order%20makanan%20/%20minuman%20di%20Cafe"
                                        target="_blank"
                                        class="w-full flex items-center justify-center gap-2.5 px-6 py-3.5 rounded-xl bg-[#25D366] hover:bg-[#20ba5a] text-white font-bold text-base transition-all duration-300 shadow-lg hover:shadow-green-500/30 transform hover:-translate-y-0.5">
                                    ...
                                    <a href="https://shopee.co.id/" target="_blank"
                                        class="w-full flex items-center justify-center gap-2.5 px-6 py-3.5 rounded-xl bg-gradient-to-r from-orange-500 to-amber-600 hover:from-orange-600 hover:to-amber-700 text-white font-bold text-base transition-all duration-300 shadow-lg hover:shadow-orange-500/30 transform hover:-translate-y-0.5">
