...
<div class="grid grid-cols-1 md:grid-cols-2 gap-6">
    ...
    <div>
        ...
        <select name="unit_id" id="unit_id" class="mt-1 block w-full p-1 border border-gray-300 rounded-md shadow-sm"
            required>
    ...
    <div class="md:col-span-2">
        ...
        <textarea name="description" id="description" rows="4"
            class="mt-1 block w-full p-1 border border-gray-300 rounded-md shadow-sm">{{ old('description', $product->description ?? '') }}</textarea>
        @error('description')
            <span class="text-sm text-red-600">{{ $message }}</span>
        @enderror
    </div>
