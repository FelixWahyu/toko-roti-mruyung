...
@section('content')
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-2xl font-bold text-gray-900 tracking-tight">Manajemen Produk</h1>
    </div>
    <div class="items-center justify-between mb-4 lg:flex">
        ...
        <form action="{{ route('admin.products.index') }}" method="GET" id="search-form">
            <div class="relative">
                <input type="text" name="search" id="search-input" placeholder="Cari produk..."
    ...
    <div id="product-data-container">
        @include('superadmin.products._table-produks', ['products' => $products])
    </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const handleSearch = (event) => {
                ...
                const url = `{{ route('admin.products.index') }}?search=${query}`;
