...
@section('content')
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-2xl font-bold text-gray-900 tracking-tight">Manajemen Unit</h1>
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                @forelse($units as $unit)
                    <tr class="hover:bg-gray-50/70 transition-colors">
                        <td class="px-5 py-3 whitespace-nowrap font-medium text-gray-900">{{ $unit->name }}</td>
                        <td class="px-5 py-3 whitespace-nowrap text-gray-600">{{ $unit->slug }}</td>
                ...
                @empty
                    <tr>
                        <td colspan="3" class="px-6 py-6 text-center text-xs text-gray-500">Tidak ada data unit.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
