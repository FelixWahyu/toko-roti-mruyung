                    ...
                    <tbody class="bg-white divide-y divide-slate-200">
                        @foreach ($limitStok as $product)
                            <tr>
                                ...
                                @if (auth()->user()->role == 'admin')
                                    <td
                                        class="px-4 flex items-center justify-left py-2 whitespace-nowrap text-right font-semibold text-slate-700">
                                        <a href="{{ route('admin.products.edit', $product) }}"
                                            class="text-sm flex items-center font-semibold bg-yellow-200 px-4 py-2 text-yellow-600 rounded-lg hover:bg-yellow-300 hover:text-yellow-700">
