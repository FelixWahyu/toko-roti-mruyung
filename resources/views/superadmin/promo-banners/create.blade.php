...
@section('content')
    <div class="text-xs mb-3 text-gray-500">
        ...
        <span class="text-gray-800 font-medium">Tambah Banner</span>
    </div>
    <h1 class="text-2xl font-bold text-gray-900 tracking-tight mb-6">Tambah Banner Promo Baru</h1>
    <div class="bg-white p-6 rounded-sm border border-gray-200">
        <form action="{{ route('admin.promo-banners.store') }}" method="POST" enctype="multipart/form-data">
            @include('superadmin.promo-banners._form', ['submitButtonText' => 'Tambah Banner'])
        </form>
    </div>
@endsection
