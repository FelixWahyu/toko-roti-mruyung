...
@section('content')
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-2xl font-bold text-gray-900 tracking-tight">Manajemen Kategori</h1>
        ...
        <table class="min-w-full divide-y divide-gray-200 text-sm">
            <thead class="bg-gray-100">
                <tr>
                    ...
                    <th class="px-5 py-3 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider">Slug</th>
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                @forelse($categories as $category)
                    <tr class="hover:bg-gray-50/70 transition-colors">
                        ...
                        <td class="px-5 py-3 whitespace-nowrap font-medium text-gray-900">{{ $category->name }}</td>
                        <td class="px-5 py-3 whitespace-nowrap text-gray-600">{{ $category->slug }}</td>
                ...
                @empty
                    <tr>
                        <td colspan="4" class="px-6 py-6 text-center text-xs text-gray-500">Tidak ada data kategori.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
