...
@section('content')
    <div class="text-xs mb-3 text-gray-500">
        ...
        <span class="text-gray-800 font-medium">Edit {{ $shippingZone->district }}</span>
    </div>
    <h1 class="text-2xl font-bold text-gray-900 tracking-tight mb-6">Edit Zona Pengiriman</h1>
